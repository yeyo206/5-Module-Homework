...
public class Searches extends CommonAPI {
    ...
    @FindBy(xpath = "//input[@class ='J-btn-search scc-t-a-search-button ui2-button ui2-button-default ui2-button-normal ui2-button-large']")
    public static WebElement subscribeButtom;
    @FindBy(xpath = "//div[@class ='J-error-tips scc-t-a-search-tips']") public static WebElement errorMessageForInvalidEmail;
    @FindBy(xpath = "//div[@class = 'J-hd-m-notify-tab sc-hd-hide-s sc-hd-ms-tab sc-hd-ms-order J-sc-hd-ms-order']")
    public static WebElement checkOrderBox;
